...
\begin{itemize}
  \item \textbf{Hash-based} commitments --- FRI, and its successors STIR and
        WHIR --- open a Merkle tree, so the assumptions are a random oracle
        plus collision resistance, together with the proximity-gap conjectures
        under which the proof of proximity is sound at its concrete
        parameters, and nothing algebraic underneath. This is what
...
FRI / WHIR & a Merkle root & random oracle; collision resistance; proximity-gap conjectures & transparent & yes \\
